    ...
    if st.session_state["OPENAI_API"] and st.session_state["SERPAPI_API"]:
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                ...
                "If the user's question contains words like '문서', 'pdf', '첨부파일', you must ALWAYS use the `pdf_search` tool and Indicate where in the referenced document the information appears."
                ...
                "Please always indicate which tools you used."
